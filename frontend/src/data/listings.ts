...
const listings: Listing[] = [
    // Praca - IT
    { id: 1, type: 'work', subcategory: 'IT', title: 'Software Developer', location: 'Warszawa', salary: '5000-10000 PLN', requirements: 'React, Node.js, MongoDB', image: 'https://media.gettyimages.com/id/1451456915/photo/female-freelance-developer-coding-and-programming-coding-on-two-with-screens-with-code.jpg?s=612x612&w=gi&k=20&c=DxUOtEcP_uDY_QINyLlGFQdB5KLKO7EgSDbIMQqOkq4=',description: 'Software Developer to kluczowa rola w nowoczesnym świecie technologii. Jako programista, będziesz odpowiedzialny za tworzenie, rozwijanie i utrzymywanie aplikacji webowych oraz systemów informatycznych. Praca ta wymaga biegłej znajomości technologii takich jak React, Node.js i MongoDB, a także zrozumienia architektury aplikacji i wzorców projektowych. Idealny kandydat powinien mieć doświadczenie w tworzeniu skalowalnych rozwiązań, umiejętność pracy w zespole oraz zdolność do szybkiego rozwiązywania problemów. Oczekujemy także, że będziesz śledzić najnowsze trendy w branży IT, aby wprowadzać innowacyjne rozwiązania i podnosić jakość dostarczanego oprogramowania. Jeśli jesteś pasjonatem programowania i chcesz tworzyć nowoczesne aplikacje, ta praca jest dla Ciebie!' },
    { id: 2, type: 'work', subcategory: 'IT', title: 'Administrator IT', location: 'Kraków', salary: '6000-9000 PLN', requirements: 'Linux, Windows Server, SQL', image: 'https://blog.strefakursow.pl/content/images/2022/05/Kim-jest-i-ile-zarabia-administrator-system-w_-1.jpg' },
    { id: 3, type: 'work', subcategory: 'IT', title: 'Tester Oprogramowania', location: 'Gdańsk', salary: '5000-7000 PLN', requirements: 'Testowanie manualne, Selenium', image: 'https://testerzy.pl/assets/img/articles/czym-zajmuje-sie-tester-oprogramowania.jpg' },
    { id: 4, type: 'work', subcategory: 'IT', title: 'Frontend Developer', location: 'Wrocław', salary: '8000-12000 PLN', requirements: 'HTML, CSS, JavaScript, React', image: 'https://img.freepik.com/free-photo/programming-background-with-person-working-with-codes-computer_23-2150010125.jpg?semt=ais_hybrid&w=740' },
